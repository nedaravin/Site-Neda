        ...
        <div class="container">
            <div class="row">
                        ...
                        @if($regional->count() > 2)
                            <div class="row">
                                <div class="col-md text-center">
                                    <a href="{{ route('news_regional.index', $language) }}"
                                       class="btn btn-link">
                                        {{ __('View More') }}
                                    </a>
                                </div>
                ...
                @if($national && $national->count())
                    <div class="col-md-12">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="card-text p-4">
                                                        ...
                                                        <p class="event-type mb-4">{{ __('National') }}</p>
                                                        <p class="event-time mb-0">
                                                            <i class="fa fa-clock-o" aria-hidden="true"></i>
                                                            {{ $news->event_start ? $news->event_start->format('l d, Y') : '' }}
                                                        </p>
                        ...
                        @if($national->count() > 2)
                            <div class="row">
                                <div class="col-md text-center">
                                    <a href="{{ route('news_national.index', $language) }}"
                                       class="btn btn-link">
                                        {{ __('View More') }}
                                    </a>
                                </div>
                ...
                @if($other && $other->count())
                    <div class="col-md-12">
                        <h2 class="sub-title mt-5">{{ __('Other') }}</h2>
                        <div class="row">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="card-text p-4">
                                                        ...
                                                        <p class="event-type mb-4">{{ __('Other') }}</p>
                                                        <p class="event-time mb-0">
                                                            <i class="fa fa-clock-o" aria-hidden="true"></i>
                                                            {{ $news->event_start ? $news->event_start->format('l d, Y') : '' }}
                                                        </p>
