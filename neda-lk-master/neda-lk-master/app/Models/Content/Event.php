...
class Event extends Model implements HasMedia
{
    ...
    protected $fillable = [
        ...
        'meta_keywords_si',
        'meta_keywords_ta',
        'type', // upcoming_events, national_level, regional_level
        'sort_order',
        'status',
        'parent_id',
        'event_start',
    ...
    public function registerMediaCollections(): void
    {
        ...
        $this->addMediaCollection('download_en')->useDisk('s3');
        $this->addMediaCollection('download_si')->useDisk('s3');
        $this->addMediaCollection('download_ta')->useDisk('s3');
    }
