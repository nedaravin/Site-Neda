 ...
 * @package App\Nova
 */
class DevelopmentOfficer extends Resource
{
    use UserFieldTrait;
    ...
    {
        return $this->getUserFields('development_officer');
    }
    ...
    {
        return [
            new EntrepreneurDistrict,
            new EntrepreneurDivisionalSecretariat
        ];
    }
    ...
    public static function indexQuery(NovaRequest $request, $query)
    {
        return $query->whereHas('roles', function ($q) {
            return $q->where('name', 'Development Officer');
        });
    }
}
